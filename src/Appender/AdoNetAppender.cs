...
namespace log4net.Appender
{
    ...
    public class AdoNetAppender : BufferingAppenderSkeleton
    {
        ...
        virtual protected Type ResolveConnectionType()
        {
            try
            {
                // TODO:�޸� SystemInfo.GetTypeFromString
                return SystemInfo.GetTypeFromString(Assembly.GetCallingAssembly(), this.ConnectionType, true, false);
        ...
        private void InitializeDatabaseConnection()
        {
            ...
            try
            {
                ...
                // TODO:EEE �������ݿ�����
                Connection = AppenderEx.CreateConnection(resolvedConnectionString, this.ConnectionType);
